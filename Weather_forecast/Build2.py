...
Hidden_Layer1 = Dense(12, input_dim=6,activation='linear');
Weather_Forecast_Model.add(Hidden_Layer1);

Hidden_Layer2 = Dense(12, activation='linear');
Weather_Forecast_Model.add(Hidden_Layer2);

Hidden_Layer3 = Dense(6, activation='linear');
Weather_Forecast_Model.add(Hidden_Layer3);

Hidden_Layer4 = Dense(6, activation='linear');
Weather_Forecast_Model.add(Hidden_Layer4);


Hidden_Layer5 = Dense(6, activation='linear');
Weather_Forecast_Model.add(Hidden_Layer5);

Hidden_Layer6 = Dense(6, activation='linear');
Weather_Forecast_Model.add(Hidden_Layer6);

Hidden_Layer7 = Dense(6, activation='linear');
